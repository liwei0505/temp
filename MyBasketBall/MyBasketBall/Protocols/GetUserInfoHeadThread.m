...
#import "GetUserInfoHeadThread.h"

@implementation GetUserInfoHeadThread

- (instancetype)initWithUserId:(int)userId visitorId:(int)visitorId {

    NSString *url = [NSString stringWithFormat:@"%@%@",PUBLIC_URL,@"/user/userinfo/head"];
