...
@implementation GetTeamInfoFollowThread


- (instancetype)initWithUserId:(int)userId teamId:(int)teamId {
    
    NSString *url = [NSString stringWithFormat:@"%@%@",PUBLIC_URL,@"/team/teaminfo/fans"];
...
- (void)requireonPrev:(void (^)())prev success:(void (^)(NSInteger))success unavaliableNetwork:(void (^)())unavaliableNetwork timeout:(void (^)())timeout exception:(void (^)(NSString *))exception {
