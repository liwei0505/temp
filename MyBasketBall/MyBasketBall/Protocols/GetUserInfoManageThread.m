...
//目前球员管理与球员参与数据结构相同，用同一个模型
//后期如果调整再分开

#import "GetUserInfoManageThread.h"
#import "UserInfoJoinModel.h"

@implementation GetUserInfoManageThread

- (instancetype)initWithUserId:(int)userId {
    
    NSString *url = [NSString stringWithFormat:@"%@%@",PUBLIC_URL,@"/user/userinfo/manage"];
